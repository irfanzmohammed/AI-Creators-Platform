...
import { LayoutDashboard,PenTool,FileText,Users, Settings, Menu } from 'lucide-react';
...
const DashboardLayout = ({children}) => {
  ...
  return (
    ...
    const isActive =
      ...
      (item.href !== "/dashboard" && pathname.startsWith(item.href));
        ...
        return(
          ...
          >
            <div className={
              cn("flex items-center px-4 py-3 space-x-3 rounded-xl transition-all duration-200 group",
                isActive
      ...
      <div className='absolute bottom-4 right-4 left-4'>
        ...
        <Button
        variant="outline"
        className="w-full justify-start p-4 rounded-xl text-slate-300 hover:text-white"
        >
    ...
    <div className='ml-0 lg:ml-64'>
      <header className='fixed top-0 right-0 w-full bg-slate-800/80 z-30 backdrop-blur-md border-b border-slate-700'>
