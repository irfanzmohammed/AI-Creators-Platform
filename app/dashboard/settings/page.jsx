...
const SettingsPage = () => {
  ...
  return (
    <div className='space-y-8 p-4 lg:p-8'>
        <div>
            <h1 className='text-3xl font-medium gradient-text-primary'>Settings</h1>
  ...
  <CardHeader>
    <CardTitle className='text-white flex items-center'>
        <User className='h-5 w-5 mr-2'/> Username Settings</CardTitle>
    <CardDescription>   Set your unique username for your public profile</CardDescription>
  ...
  <CardContent>
   ...
   <form className='space-y-6' onSubmit={handleSubmit}>
    <div className='space-y-2'>
      ...
      id="username"
      value={username}
      className='bg-slate-800 border-s-slate-600 text-white'
