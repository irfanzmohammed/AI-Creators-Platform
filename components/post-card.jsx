...
const PostCard = (
 ...
 // Get post URL for public viewing
  ...
  return <Card className={`card-glass hover:border-purple-50 transition-colors ${className}`}>
    <CardContent>
              ...
              <div className='relative h-8 w-8'>
                {
                  ...
                  <div className='w-full h-full rounded-full bg-gradient-to-br from-purple-600  to-blue-400
